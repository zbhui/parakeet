...
//}
//
//void NavierStokesBC::precalculateJacobian()
//{
//
//}
...
//}
//
//Real NavierStokesBC::computeQpResidual(unsigned int p)
//{
//	return _flux[p] * _test[_i][_qp] + 0.5*_epsilon * _penalty[_qp][p]* _grad_test[_i][_qp];
//}
//
//Real NavierStokesBC::computeQpJacobian(unsigned int p, unsigned int q)
//{
//	return 0.;
//}
//
//void NavierStokesBC::wall(Real* ur)
//{
//	Real ui[5];
//	valueAtLeftFace(ui);
